...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-50 dark:bg-darkBg text-slate-900 dark:text-white pt-24 pb-12 border-t border-slate-200 dark:border-white/5 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-white dark:bg-white/5 p-2 rounded-xl border border-slate-200 dark:border-white/10">
            ...
            <div className="flex gap-4">
              {[FiFacebook, FiInstagram, FaWhatsapp].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-brandOrange dark:hover:text-brandOrange hover:border-brandOrange/30 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={link.name}>
                  <a href={link.href} className="text-sm text-slate-600 dark:text-slate-400 hover:text-brandOrange dark:hover:text-white transition-colors flex items-center gap-2 group">
          ...
          <div>
            ...
            <div className="space-y-6">
              <a href="mailto:infomapmendsolution@gmail.com" className="flex items-center gap-4 group">
                <div className="w-10 h-10 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-400 group-hover:text-brandOrange transition-colors">
                  <FiMail />
                </div>
                <div>
                   <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Email Control</div>
                   <div className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-brandOrange transition-colors">infomapmendsolution@gmail.com</div>
                </div>
              </a>
