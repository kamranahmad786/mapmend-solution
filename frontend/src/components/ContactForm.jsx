      ...
      <div className="max-w-4xl mx-auto px-6 w-full relative z-10">
        ...
        >
          ...
          <div className="relative z-10">
            <FaUser className="absolute top-4 left-4 text-brandBlue" />
            <input
              required
              value={form.name}
          ...
          {/* Business */}
          <div className="relative z-10">
            <FaBuilding className="absolute top-4 left-4 text-brandBlue" />
            <input
              value={form.business}
          ...
          {/* Email */}
          <div className="relative z-10">
            <FaEnvelope className="absolute top-4 left-4 text-brandBlue" />
            <input
              value={form.email}
          ...
          {/* Phone */}
          <div className="relative z-10">
            <FaPhone className="absolute top-4 left-4 text-brandBlue" />
            <input
              required
              value={form.phone}
          ...
          <div className="relative md:col-span-2 z-10">
            <FaCommentDots className="absolute top-4 left-4 text-brandBlue" />
            <textarea
              required
              value={form.message}
          ...
          <div className="md:col-span-2 flex flex-col sm:flex-row gap-6 sm:items-center mt-2 z-10">
            ...
            <button
              type="submit"
              className="bg-brandOrange text-white px-10 py-3.5 rounded-xl font-bold shadow-[0_0_15px_rgba(245,132,31,0.4)] hover:bg-orange-600 transition-transform hover:scale-105"
            >
              Initialize Audit
            </button>
            ...
            {/* WhatsApp Button */}
            <a
              className="flex items-center gap-2 text-brandBlue font-semibold text-sm hover:text-blue-400 transition"
            ...
            {status === "success" && (
              <div className="text-sm text-brandBlue font-semibold">
